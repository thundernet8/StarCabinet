...
export default class RepoDetail extends React.Component {
    render() {
        ...
        pushTime =
            pushTime.toLocaleDateString() + " " + pushTime.toLocaleTimeString();

        return (
            <div
                className={classNames(
                    "repoDetailInner",
                    styles.repoDetailInner
                )}
            >
                <header>
                    <div className={styles.headtitle}>
                        <Icon type="home" />
                        <a
                            href={this.props.selectedRepo.htmlUrl.replace(
                                fullName,
                                namePieces[0]
                            )}
                            target="_blank"
                        ...
                        <span>/</span>
                        <a
                            href={this.props.selectedRepo.htmlUrl}
                            target="_blank"
                        >
                            {namePieces[1]}
                        </a>
